"""
Write a class MobilePhone which has an init function with the attributes for
display size, RAM, and operating system

This class should work seamlessly with the codee below to print an automated review
"""
